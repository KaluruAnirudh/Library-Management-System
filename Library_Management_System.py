...
class LibraryManagement:
    def __init__(self, master):
        ...
        self.username_label = tk.Label(self.master, text="Username", font=("calibri", 16), bg='#708090', fg='white')
        self.username_label.pack()
        self.username_entry = tk.Entry(self.master, font=("calibri", 12))
        self.username_entry.pack()
        self.password_label = tk.Label(self.master, text="Password", font=("calibri", 16), bg='#708090', fg='white')
        self.password_label.pack()
        self.password_entry = tk.Entry(self.master, font=("calibri", 16), show="*")
    ...
    def add_book(self):
        ...
        messagebox.showinfo("Success", "Book has been stored successfully")
